...
class DeckTests(unittest.TestCase):
    ...
    def test_init(self):
        """decks should have a card attribute which is a list of cards"""
    ...
    def test_count(self):
        """count should return the current number of cards in deck"""
    ...
    def test_deal_card(self):
        """deal card should deal a single card from the deck"""
